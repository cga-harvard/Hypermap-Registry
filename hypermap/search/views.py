...
def csw_global_dispatch(request):
    ...
    csw = server.Csw(settings.HYPERMAP_PYCSW, env, version='2.0.2')
...
def opensearch_dispatch(request):
    ...
    ctx = {
        'shortname': settings.HYPERMAP_PYCSW['metadata:main']['identification_title'],
        'description': settings.HYPERMAP_PYCSW['metadata:main']['identification_abstract'],
        'developer': settings.HYPERMAP_PYCSW['metadata:main']['contact_name'],
        'contact': settings.HYPERMAP_PYCSW['metadata:main']['contact_email'],
        'attribution': settings.HYPERMAP_PYCSW['metadata:main']['provider_name'],
        'tags': settings.HYPERMAP_PYCSW['metadata:main']['identification_keywords'].replace(',', ' '),
