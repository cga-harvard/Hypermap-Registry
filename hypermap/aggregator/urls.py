...
urlpatterns = [
    ...
    url(r'^(?P<catalog_slug>[-\w]+)/service/(?P<service_id>\d+)/checks$', views.service_checks, name='service_checks'),
    ...
    url(r'^(?P<catalog_slug>[-\w]+)/layer/(?P<layer_id>\d+)/map(?P<path_info>/.*)$', views.layer_mapproxy, name='layer_mapproxy'),
    url(r'^(?P<catalog_slug>[-\w]+)/layer/(?P<layer_id>\d+)/map/config$', views.layer_mapproxy, name='layer_mapproxy_config'),
